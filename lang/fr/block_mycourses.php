...
$string['customfiltergrouping_nofields'] = 'Cette option nécessite la configuration d\'un champ personnalisé de cours visible par tous.';
$string['displaycategories'] = 'Afficher les catégories';
$string['displaycategories_help'] = 'Afficher la catégorie du cours sur les éléments du tableau de bord, y compris les cartes, les éléments de liste et les éléments de résumé.';
...
$string['blocktitle:teacher'] = 'Cours enseignés';
$string['blocktitle:student'] = 'Mon apprentissage';
...
$string['zero_request_intro'] = 'Besoin d\'aide pour commencer ? Consultez la <a href="{$a->dochref}" title="{$a->doctitle}" target="{$a->doctarget}">documentation Moodle</a> ou faites vos premiers pas avec notre <a href="{$a->quickhref}" title="{$a->quicktitle}" target="{$a->quicktarget}">guide de démarrage rapide</a>.';
$string['zero_nocourses_title'] = 'Créez votre premier cours';
$string['zero_nocourses_intro'] = 'Besoin d\'aide pour commencer ? Consultez la <a href="{$a->dochref}" title="{$a->doctitle}" target="{$a->doctarget}">documentation Moodle</a> ou faites vos premiers pas avec notre guide de démarrage rapide.';
