...
/**
 * Javascript to initialise the selectors for the mycourses block.
 *
...
export default {
    ...
    ACTION_INVISIBLE_COURSE: '[data-action="invisible-course"]',
    ACTION_VISIBLE_COURSE: '[data-action="visible-course"]',
    ...
    region: {
        selectBlock: '[data-region="mycourses"]',
